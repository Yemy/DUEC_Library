...
<!--     <script type="text/javascript">
        ...
        $.post('update-issue-bookdeails.php',{catId: catId}).done(function(data){
            // console.log(data);
