...
$tnofbooks=$_POST['tnofbooks'];

$bookid=intval($_GET['bookid']);
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price,nofbooks=:noofbooks,tnofbooks=:tnofbooks where id=:bookid";
...
$query->bindParam(':tnofbooks',$tnofbooks,PDO::PARAM_STR);
...
<p class="help-block">ISBN Must be unique</p>
 ...
 <input class="form-control" type="text" name="noofbooks" value="<?php echo htmlentities($result->nofbooks);?>"   required="required" />
   ...
   <div class="form-group">
 <label>Total #Books<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="noofbooks" value="<?php echo htmlentities($result->tnofbooks);?>"   required="required" />
 </div>
 <?php }} ?>
